...
public final class Plasma extends LinearColorMap {
    public Plasma(Double lowValue, Double highValue) {
        super(lowValue, highValue,
                ...
                new Color(0.293478f, 0.010213f, 0.62949f),
                new Color(0.299855f, 0.009561f, 0.631624f),
                new Color(0.30621f, 0.008902f, 0.633694f),
                new Color(0.312543f, 0.008239f, 0.6357f),
                new Color(0.318856f, 0.007576f, 0.63764f),
                new Color(0.32515f, 0.006915f, 0.639512f),
                new Color(0.331426f, 0.006261f, 0.641316f),
                new Color(0.337683f, 0.005618f, 0.643049f),
                new Color(0.343925f, 0.004991f, 0.64471f),
                new Color(0.35015f, 0.004382f, 0.646298f),
                new Color(0.356359f, 0.003798f, 0.64781f),
                ...
                new Color(0.41158f, 0.000577f, 0.65773f),
                new Color(0.417642f, 0.000564f, 0.65839f),
                new Color(0.423689f, 0.000646f, 0.658956f),
                new Color(0.429719f, 0.000831f, 0.659425f),
                new Color(0.435734f, 0.001127f, 0.659797f),
                new Color(0.441732f, 0.00154f, 0.660069f),
                new Color(0.447714f, 0.00208f, 0.66024f),
                new Color(0.453677f, 0.002755f, 0.66031f),
                new Color(0.459623f, 0.003574f, 0.660277f),
                new Color(0.46555f, 0.004545f, 0.660139f),
                new Color(0.471457f, 0.005678f, 0.659897f),
                new Color(0.477344f, 0.00698f, 0.659549f),
                new Color(0.48321f, 0.00846f, 0.659095f),
                new Color(0.489055f, 0.010127f, 0.658534f),
                new Color(0.494877f, 0.01199f, 0.657865f),
                ...
                new Color(0.54057f, 0.03495f, 0.64864f),
                new Color(0.546157f, 0.038954f, 0.64701f),
                ...
                new Color(0.65558f, 0.129725f, 0.592317f),
                ...
                new Color(0.67916f, 0.151848f, 0.575189f),
                new Color(0.683758f, 0.156278f, 0.57166f),
                new Color(0.688318f, 0.160709f, 0.568103f),
                new Color(0.69284f, 0.165141f, 0.564522f),
                ...
                new Color(0.72767f, 0.200586f, 0.535293f),
                ...
                new Color(0.840155f, 0.33358f, 0.427455f),
                ...
                new Color(0.907365f, 0.434524f, 0.35297f),
                new Color(0.910098f, 0.439268f, 0.34961f),
                new Color(0.9128f, 0.444029f, 0.346251f),
                new Color(0.915471f, 0.448807f, 0.34289f),
                ...
                new Color(0.933232f, 0.48278f, 0.319325f),
                new Color(0.93563f, 0.487712f, 0.315952f),
                new Color(0.93799f, 0.492667f, 0.312575f),
                ...
                new Color(0.951344f, 0.52285f, 0.292275f),
                new Color(0.953428f, 0.52796f, 0.288883f),
                new Color(0.95547f, 0.533093f, 0.28549f),
                new Color(0.957469f, 0.53825f, 0.282096f),
                ...
                new Color(0.985301f, 0.63533f, 0.221265f),
                new Color(0.986345f, 0.640969f, 0.217948f),
                new Color(0.987332f, 0.646633f, 0.214648f),
                new Color(0.98826f, 0.652325f, 0.211364f),
                new Color(0.989128f, 0.658043f, 0.2081f),
                ...
                new Color(0.992541f, 0.68703f, 0.19217f),
                new Color(0.993032f, 0.692907f, 0.189084f),
                new Color(0.993456f, 0.69881f, 0.186041f),
                ...
                new Color(0.994495f, 0.74088f, 0.166335f),
                ...
                new Color(0.98119f, 0.848329f, 0.142279f),
                ...
                new Color(0.97253f, 0.88125f, 0.144923f),
                new Color(0.970533f, 0.887896f, 0.145919f),
                new Color(0.968443f, 0.894564f, 0.147014f),
                new Color(0.966271f, 0.901249f, 0.14818f),
                new Color(0.964021f, 0.90795f, 0.14937f),
                new Color(0.961681f, 0.914672f, 0.15052f),
                ...
                new Color(0.946602f, 0.95519f, 0.150328f),
                new Color(0.944152f, 0.961916f, 0.146861f),
                new Color(0.941896f, 0.96859f, 0.140956f),
